...
var utils = module.exports = {
  ...
  protoExtend: function(sub) {
    ...
    for (i in Super) {
      // xTuple PATCH: https://github.com/bendiy/stripe-node/commit/3cf638611d090880290b2927d8e72f33065436cb
      // TODO: Qt Script has a bug where Object.prototype is enumerated, so it
      // shows up in for loops. We have to skip it here or this blows up.
      if (i === 'prototype') {
        continue;
      }
